...
ActiveRecord::Schema.define(version: 20150611150641) do
  ...
  add_index "polls", ["author_user_id"], name: "index_polls_on_author_user_id", using: :btree
  ...
  create_table "responses", force: true do |t|
    ...
    t.integer  "respondent_user_id", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "responses", ["answer_choice_id"], name: "index_responses_on_answer_choice_id", using: :btree
  add_index "responses", ["respondent_user_id"], name: "index_responses_on_respondent_user_id", using: :btree
